...
export const CONFIG_FIELD_SEARCH_INDEX: ConfigFieldSearchEntry[] = [
  ...
  {
    fieldId: 'managementGzipEnabled',
    sectionId: 'logging',
    labelKey: L('sections.system.management_gzip_enabled'),
    hintKey: L('sections.system.management_gzip_enabled_desc'),
    yamlKeys: ['management-performance', 'gzip-enabled'],
  },
  {
    fieldId: 'usageRecentCacheEnabled',
    sectionId: 'logging',
    labelKey: L('sections.system.usage_recent_cache_enabled'),
    hintKey: L('sections.system.usage_recent_cache_enabled_desc'),
    yamlKeys: ['management-performance', 'usage-recent-cache-enabled'],
  },
  // ── quota ─────────────────────────────────────────────────────────────────
  {
    fieldId: 'quotaShowClaude',
    sectionId: 'quota',
    labelKey: L('sections.quota.show_claude'),
    hintKey: L('sections.quota.provider_visibility_desc'),
    keywords: ['quota', 'claude', 'browser', 'localstorage'],
  },
  {
    fieldId: 'quotaShowAntigravity',
    sectionId: 'quota',
    labelKey: L('sections.quota.show_antigravity'),
    hintKey: L('sections.quota.provider_visibility_desc'),
    keywords: ['quota', 'antigravity', 'browser', 'localstorage'],
  },
  {
    fieldId: 'quotaShowXai',
    sectionId: 'quota',
    labelKey: L('sections.quota.show_xai'),
    hintKey: L('sections.quota.provider_visibility_desc'),
    keywords: ['quota', 'xai', 'browser', 'localstorage'],
  },
  {
    fieldId: 'quotaShowKimi',
    sectionId: 'quota',
    labelKey: L('sections.quota.show_kimi'),
    hintKey: L('sections.quota.provider_visibility_desc'),
    keywords: ['quota', 'kimi', 'browser', 'localstorage'],
  },
  {
